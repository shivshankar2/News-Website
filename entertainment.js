...
import entertainment from "../News/entertainment.json"
...
const Entertainment = () => {
  ...
  useEffect(() => {
    fetch(
      "https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=22b4e6c6f2b94cc19d4eed701db86018"
    )
      .then((res) => res.json())
    ...
    <>
      <Layout>
        <div className="md:text-4xl text-xl mt-[2rem] grid justify-center font-bold text-slate-500">
          <h2>Top Headlines - entertainment</h2>
        </div>
  ...
  <div className="container px-5 py-12 mx-auto">
    <div className="flex flex-wrap m-4">
        ...
        {
            entertainment.articles?.map((article)=>{
                return(
