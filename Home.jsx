...
import home from "../News/home.json"
            ...
            home.articles?.map((article)=>{
                return(
                    ...
                    <div className="py-5">
                      ...
                      <h2 className="title-font text-md font-medium text-slate-600 mb-2">{article.title.slice(0,80)}...</h2>
                      </a>

                    <a href={article.url} target="_blank" rel="noreferrer" >
                      <p className="leading-relaxed mb-3 text-sm">{article.description.slice(0,160)}...</p>
                      </a>
