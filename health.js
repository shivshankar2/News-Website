...
import health from "../News/health.json"
...
const Health = () => {
  ...
  useEffect(() => {
    fetch(
      "https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=22b4e6c6f2b94cc19d4eed701db86018"
    )
      .then((res) => res.json())
