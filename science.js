...
import science from "../News/science.json"
...
const Science = () => {
  ...
  useEffect(() => {
    fetch(
      "https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=22b4e6c6f2b94cc19d4eed701db86018"
    )
      .then((res) => res.json())
